      ...
      >
        ...
        >
          <Box css={{ marginBottom: "$48" }}>
            <Title level="3">What is virality technically?</Title>
            <Paragraph>
          ...
          >
            <Title level="3">Virality types</Title>
            <Paragraph>
          ...
          >
            ...
            />
            <Title level="4">1. Word of mouth virality</Title>
            <Paragraph>
          ...
          >
            ...
            />
            <Title level="4">2. Demonstration virality</Title>
            <Paragraph>
          ...
          >
            ...
            />
            <Title level="4">3. Outbreak virality</Title>
            <Paragraph>
          ...
          >
            ...
            />
            <Title level="4">4. Network Virality</Title>
            <Paragraph>
          ...
          >
            ...
            />
            <Title level="4">5. Incentive Virality</Title>
            <Paragraph>
          ...
          >
            <Title level="3">Common traits</Title>
            <Paragraph>
            ...
            <List>
              ...
              <li>
                <Title level="5">Organizational technology:</Title>
                <Paragraph>
              ...
              <li>
                <Title level="5">Simple concept:</Title>
                <Paragraph>Easy and intuitive to use.</Paragraph>
              </li>
              <li>
                <Title level="5">Built-in virality:</Title>
                <Paragraph>
              ...
              <li>
                <Title level="5">Network effects:</Title>
                <Paragraph>
              ...
              <li>
                <Title level="5">Stackability:</Title>
                <Paragraph>
          ...
          >
            ...
            <Title level="3">In use mechanisms</Title>
          ...
          >
            <Title level="4">1. Sharable content</Title>
            <Paragraph>
            ...
            <List>
              ...
              <li>
                <Title level="5">Prisma, Instagram, TikTok, Snapchat … </Title>
                <Paragraph>
          ...
          >
            <Title level="4">2. Commodities</Title>
            <Paragraph>
            ...
            <List>
              ...
              <li>
                <Title level="5">“Book me” apps (Booksy, Bookme …)</Title>
                <Paragraph>
          ...
          >
            ...
            <List>
              <li>
                <Title level="5">Tupperware </Title>
                <Paragraph>
          ...
          >
            ...
            <List>
              <li>
                <Title level="5">Intercom</Title>
                <Paragraph>{`to be added`}</Paragraph>
              </li>
              <li>
                <Title level="5">App Store</Title>
                <Paragraph>{`to be added`}</Paragraph>
              </li>
              <li>
                <Title level="5">Aviasales</Title>
                <Paragraph>{`to be added`}</Paragraph>
              </li>
            </List>
          </Box>
          ...
          >
            <Title level="4">5. Side mission</Title>
            <Paragraph>
              That is something most of us think of hearing the word "Virality".
              It usually happens when the product is so exciting that users
              mention it to everyone around. Or it makes some of their routines
            ...
            <List>
              <li>
                <Title level="5">Airbnb</Title>
                <Paragraph>{`to be added`}</Paragraph>
              </li>
              <li>
                <Title level="5">H&M</Title>
                <Paragraph>{`to be added`}</Paragraph>
              </li>
              <li>
          ...
          >
            <Title level={3}>What's now?</Title>
            <Paragraph>
